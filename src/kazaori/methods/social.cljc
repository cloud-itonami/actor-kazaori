(ns kazaori.methods.social
  "social.cljc — 風折 — Civilian Disaster Response DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from kazaori's own
...
(def DISCLAIMER
  (str "【観測ミラー / accountability map — NOT a verdict, NOT advice, 非断定】 "
       "風折 — Civilian Disaster Response が既知の観測から編んだ事実の要約です。"))
...
(defn draft-observation-post
  "A dry-run observation post over kazaori's own domain (Non-profit religious-corp civilian disaster response substrate. Earthquake / typhoon / flood / wildfire / pandemic / power outage / water…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "kazaori R0: live social posting is Council Lv6+ + operator + "
